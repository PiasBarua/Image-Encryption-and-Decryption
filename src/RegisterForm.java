...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField_UN.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jPasswordField_PASS.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jButton_CANCEL.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jTextField_FN.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jTextField_LN.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jPasswordField_REPASS.setBackground(new java.awt.Color(0, 204, 204));
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
          ...
          String query="Insert into register_user(u_fname, u_lname, u_uname, u_pass) values(?,?,?,?)";
        try {
    ...
    public boolean checkUsername(String username){
        ...
        boolean checkUser = false;
         ...
         String query = "SELECT * FROM register_user where u_uname=?";
        try {
            ps= MyConnection.getConnection().prepareStatement(query);
